...
<div id="waps">
  <div class="header">
    <div class="top">
      ...
      <div class="top_1">
        <div id="showEwm"><img src="/Public/Home/images/wx_ico.png" style="margin-top:-8px;" align="middle">  关注识习网微信<span id="bigewm"><img src="/Public/Home/images/1488264231.png" alt=""></span></div>
...
<div class="middle">
    <div class="tskclm">
        <div class="tskclmm">
            ...
            <div class="tskclm_r">
                <div class="tskc_h2"><h2><?php echo ($catename); ?></h2><span><?php echo ($position); ?></span></div>
                    <ul style="margin-top:15px;">
                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="searLi">
                    <a href="<?php echo ($vo['url']); ?>" title="<?php echo ($vo['title']); ?>"><img src="<?php echo thumb($vo['thumb'],150,150);?>"><span><?php echo ($vo['title']); ?></span></a>
