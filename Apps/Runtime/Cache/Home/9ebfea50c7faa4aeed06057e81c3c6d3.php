...
<div class="w container product-section">
<div class="pro_art">
    <div class="h2_ze"><h2>产品资讯</h2><small>Information</small></div>
    <ul>
    <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i <= 2): ?><li class="recom">
            <div class="left"><a href="<?php echo ($vo['url']); ?>"><?php echo ($vo['title']); ?> <img src="/Public/Home/images/img1.gif" alt=""></a><p><?php echo ($vo['description']); ?></p><a href="<?php echo ($vo['url']); ?>"  class="more">更多>></a></div>
            <div class="right"><a href="<?php echo ($vo['url']); ?>"><img src="<?php echo thumb($vo['thumb'],250,182);?>" alt="<?php echo ($vo['title']); ?>"></a></div>
        </li>
    <?php else: ?>
        <li><a href="<?php echo ($vo['url']); ?>"> >><?php echo ($vo['title']); ?></a><span><?php echo date('m/d',$vo['create_time']);?></span></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
    </ul>
</div>
<div class="clear"></div>
<div class="product-box">
    <div class="h2_ze"><h2>产品中心</h2><small>Product</small></div>
    <ul>
    <?php if(is_array($product_category)): $k = 0; $__LIST__ = $product_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if(($vo['id']) != "8"): ?><li>
            <div class="img">
            <?php if(($k) == "1"): ?><img src="/Public/Home/images/pro_ico.png" alt="<?php echo ($vo['title']); ?>"><?php endif; ?>
            <?php if(($k) == "2"): ?><img src="/Public/Home/images/pro_ico2.png" alt="<?php echo ($vo['title']); ?>"><?php endif; ?>
            <?php if(($k) == "3"): ?><img src="/Public/Home/images/pro_ico4.png" alt="<?php echo ($vo['title']); ?>"><?php endif; ?>
            <?php if(($k) == "4"): ?><img src="/Public/Home/images/pro_ico1.png" alt="<?php echo ($vo['title']); ?>"><?php endif; ?>
            <?php if(($k) == "5"): ?><img src="/Public/Home/images/pro_ico3.png" alt="<?php echo ($vo['title']); ?>"><?php endif; ?>
            <?php if(($k) == "6"): ?><img src="/Public/Home/images/pro_ico5.png" alt="<?php echo ($vo['title']); ?>"><?php endif; ?>
            </div>
            <div class="title"><span><?php echo ($vo['title']); ?></span>
                <dl>
                <?php if(is_array($vo['childs'])): $i = 0; $__LIST__ = $vo['childs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><dt><a href="<?php echo ($val['url']); ?>">· <?php echo ($val['title']); ?></a></dt><?php endforeach; endif; else: echo "" ;endif; ?>
                </dl>
            </div>
            <div class="more"><a href="<?php echo ($vo['url']); ?>">更多>></a></div>
