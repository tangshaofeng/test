...
<div class="middle">
    <div class="wd1100 bgwrite policy-section">
        <ul>
        <?php if(is_array($Policy_childs)): $i = 0; $__LIST__ = $Policy_childs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span><?php echo ($vo['title']); ?></span>
            <dl>
            <?php $_result=get_category($vo['id']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><dt><a href="<?php echo ($val['url']); ?>"><?php echo ($val['title']); ?></a></dt><?php endforeach; endif; else: echo "" ;endif; ?>
            </dl>
