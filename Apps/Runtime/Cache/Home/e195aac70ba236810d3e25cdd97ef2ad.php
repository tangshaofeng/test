...
<div class="middle">
    <div class="tskclm">
        <div class="tskclmm">
            <div class="tskclm_l">
                <div class="ts_h2">
                    <h2><?php echo ($topinfo['title']); ?></h2><small></small>
                </div>
            <ul>
                <?php $_result=get_category($top_catid);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($val['url']); ?>" <?php if($val['id']==$catid): ?>class="cont_p"<?php endif; ?>><?php echo ($val['title']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            </div>
            <div class="tskclm_r">
                <div class="tskc_h2"><h2><?php echo ($catename); ?></h2><span><?php echo catpos($catid);?></span></div>
                <div class="tskc_box">
                <ul>
                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="ts_01">
                    <i><b><a href="<?php echo ($vo['url']); ?>"><img src="<?php echo thumb($vo['thumb']);?>" border="0"></a></b>
                    <em><a href="<?php echo ($vo['url']); ?>"><font color="#333333"><?php echo ($vo['title']); ?></font></a></em></i>
                    <div style="clear:both"></div>
                    <div class="ts_desc"><a href="<?php echo ($vo['url']); ?>"><?php echo msubstr($vo['description'],0,40);?></a></div>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                </div>
                <div style="clear:both;"></div>
                <div class="dede_pages"><?php echo ($page); ?></div>
            </div>
