...
<div class="w container">
    ...
    <div class="right page_boby">
        <?php if(($info['con_name']) == null): else: ?> <h4 class="h4_bt"><span><?php echo ($info['con_name']); ?></span></h4>
        <div class="art_con"><?php echo ($info['content']); ?></div><?php endif; ?>
      <?php if(($info['con_name1']) == null): else: ?> <h4 class="h4_bt"><span><?php echo ($info['con_name1']); ?></span></h4>
        <div class="art_con"><?php echo ($info['content1']); ?></div><?php endif; ?>
      <?php if(($info['con_name2']) == null): else: ?> <h4 class="h4_bt"><span><?php echo ($info['con_name2']); ?></span></h4>
        <div class="art_con"><?php echo ($info['content2']); ?></div><?php endif; ?>
      <?php if(($info['con_name3']) == null): else: ?> <h4 class="h4_bt"><span><?php echo ($info['con_name3']); ?></span></h4>
        <div class="art_con"><?php echo ($info['content3']); ?></div><?php endif; ?>
      <?php if(($info['con_name4']) == null): else: ?> <h4 class="h4_bt"><span><?php echo ($info['con_name4']); ?></span></h4>
        <div class="art_con"><?php echo ($info['content4']); ?></div><?php endif; ?>
