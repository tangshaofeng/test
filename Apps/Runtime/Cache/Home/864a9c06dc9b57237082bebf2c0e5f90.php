...
<div class="w container">
    ...
    <div class="right">
      <div class="news-list">
          <ul>
          <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i <= 3): ?><li class="first" <?php if(($i) == "1"): ?>style="margin-left:0px;"<?php endif; ?>><a href="<?php echo ($vo['url']); ?>" title="<?php echo ($vo['title']); ?>"><img src="<?php echo thumb($vo['thumb'],302,220);?>" width="302" height="220" alt="<?php echo ($vo['title']); ?>"><span><em><?php echo date('m-d',$vo['create_time']);?></em><?php echo ($vo['title']); ?></span></a></li>
          <?php else: ?>
