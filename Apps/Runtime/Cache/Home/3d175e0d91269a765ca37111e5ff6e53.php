...
<div class="middle">
    ...
    <div class="tskclmm">
        <div class="tskclm_l">
           <div class="ts_h2"><h2><?php echo ($topinfo['title']); ?></h2></div>
            <ul>
        ...
        <div class="tskclm_r">
            <div class="post1">您当前的位置：<?php echo catpos($catid);?></div>
            <div class="art_txt">
                <div class="art_h2"><h3><?php echo ($info['title']); ?></h3></div>
                <div class="art_small"><small>发布时间：<?php echo date('Y-m-d H:i',$info['create_time']);?></small><small>浏览量：<?php echo ($info['hit']); ?></small></div>
                <div class="art_boby"><?php echo ($info['content']); ?></div>
                <div class="pages">
                <span>上一篇：<?php echo ($prev); ?>  </span>
                <span>下一篇：<?php echo ($next); ?>  </span>
                </div>
                <!--相关内容--><div style="clear:both"></div><!--相关内容-->
