        ...
        <div class="tskclmm">
            ...
            <div class="tskclm_r">
                ...
                <ul class="teacher-lists">
                    ...
                    <div class="left"><a href="<?php echo ($vo['url']); ?>"><img src="<?php echo thumb($vo['thumb'],104,126);?>" alt="" width="104" height="126" /></a></div>
                    <div class="right"><h3><a href="<?php echo ($vo['url']); ?>"><?php echo ($vo['title']); ?></a></h3><p><?php echo msubstr($vo['description'],0,74);?></p><span><a href="<?php echo ($vo['url']); ?>">详情及教育视频></a></span></div>
