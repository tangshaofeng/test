...
<li onclick="SwapTab('setting','on','',8,1);" class="on" id="tab_setting_1">基本选项</li>
<li onclick="SwapTab('setting','on','',8,2);" id="tab_setting_2">内容1</li>
<li onclick="SwapTab('setting','on','',8,3);" id="tab_setting_3">内容2</li>
<li onclick="SwapTab('setting','on','',8,4);" id="tab_setting_4">内容3</li>
<li onclick="SwapTab('setting','on','',8,5);" id="tab_setting_5">内容4</li>
<li onclick="SwapTab('setting','on','',8,6);" id="tab_setting_6">内容5</li>
<li onclick="SwapTab('setting','on','',8,8);" id="tab_setting_8">内容6</li>
<li onclick="SwapTab('setting','on','',8,7);" id="tab_setting_7">SEO 设置</li>
...
<table width="100%" cellspacing="0" class="table_form">
    ...
    <tr>
      <th> 内容标题     </th>
      <td><input type="text" name="con_name" id="con_name" value="<?php echo ($info['con_name']); ?>" style="width:280px" class="input-text"></td>
    </tr>
     <tr>
    ...
    <tr>
      <th> 内容标题     </th>
      <td><input type="text" name="con_name1" id="con_name1" value="<?php echo ($info['con_name1']); ?>" style="width:280px" class="input-text"></td>
    </tr>
     <tr>
      <th width="80"> <font color="red">*</font> 内容</th>
      <td><script id="container1" name="content1" type="text/plain"><?php echo (html_entity_decode((isset($info['content1']) && ($info['content1'] !== ""))?($info['content1']):'')); ?></script></td>
    </tr>
    </tbody>
    </table>
    </div>
    <!---->
    <!---->
    <div class="contentList hidden" id="div_setting_4">
    <table width="100%" cellspacing="0" class="table_form">
    <tbody> 
    <tr>
      <th> 内容标题     </th>
      <td><input type="text" name="con_name2" id="con_name2" value="<?php echo ($info['con_name2']); ?>" style="width:280px" class="input-text"></td>
    </tr>
     <tr>
      <th width="80"> <font color="red">*</font> 内容</th>
      <td><script id="container2" name="content2" type="text/plain"><?php echo (html_entity_decode((isset($info['content2']) && ($info['content2'] !== ""))?($info['content2']):'')); ?></script></td>
    </tr>
    </tbody>
    </table>
    </div>
    <!---->
    <!---->
    <div class="contentList hidden" id="div_setting_5">
    <table width="100%" cellspacing="0" class="table_form">
    <tbody> 
    <tr>
      <th> 内容标题     </th>
      <td><input type="text" name="con_name3" id="con_name3" value="<?php echo ($info['con_name3']); ?>" style="width:280px" class="input-text"></td>
    </tr>
     <tr>
      <th width="80"> <font color="red">*</font> 内容</th>
      <td><script id="container3" name="content3" type="text/plain"><?php echo (html_entity_decode((isset($info['content3']) && ($info['content3'] !== ""))?($info['content3']):'')); ?></script></td>
    </tr>
    </tbody>
    </table>
    </div>
    <!---->
    <!---->
    <div class="contentList hidden" id="div_setting_6">
    <table width="100%" cellspacing="0" class="table_form">
    <tbody> 
      <tr>
      <th> 内容标题     </th>
      <td><input type="text" name="con_name4" id="con_name4" value="<?php echo ($info['con_name4']); ?>" style="width:280px" class="input-text"></td>
    </tr>
     <tr>
      <th width="80"> <font color="red">*</font> 内容</th>
      <td><script id="container4" name="content4" type="text/plain"><?php echo (html_entity_decode((isset($info['content4']) && ($info['content4'] !== ""))?($info['content4']):'')); ?></script></td>
    </tr>
    </tbody>
    </table>
    </div>
    <!---->
    <div class="contentList hidden" id="div_setting_8">
    <table width="100%" cellspacing="0" class="table_form">
    <tbody> 
     <tr>
      <th> 内容标题     </th>
      <td><input type="text" name="con_name5" id="con_name5" value="<?php echo ($info['con_name5']); ?>" style="width:280px" class="input-text"></td>
    </tr>
     <tr>
      <th width="80"> <font color="red">*</font> 内容</th>
      <td><script id="container5" name="content5" type="text/plain"><?php echo (html_entity_decode((isset($info['content5']) && ($info['content5'] !== ""))?($info['content5']):'')); ?></script></td>
    </tr>
    </tbody>
    </table>
    </div>
    <!---->
    <div class="contentList hidden" id="div_setting_7">
    <table width="100%" cellspacing="0" class="table_form">
    <tbody> 
    <tr>
