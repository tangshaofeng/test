...
<div class="pad-20">
       ...
       <label for="check_box">全选/取消</label>
        <a class="btn-warning " title="排序" href="javascript:void(0);" onclick="myform.action='<?php echo U('Yunzhansystem/Ads/more_del?action=1&catid='.$catid);?>';myform.submit();">排序</a>
         <?php if(($category['is_lower']) == "1"): ?><a class="btn-danger" title="批量删除" href="javascript:void(0)" onclick="myform.action='<?php echo U('Yunzhansystem/Ads/more_del?action=2&catid='.$catid);?>';myform.submit();">批量删除</a>
        <a class="btn-warning " title="添加信息" href="<?php echo U('Yunzhansystem/Ads/add?catid='.$catid);?>" >添加广告位</a><?php endif; ?>
       </span>
...
<div class="fr"></div>
    ...
    <td align="center">
    <?php echo get_row('版位',$val['catid'],'title');?></td>
    <td align="center"><a href="<?php echo U('Yunzhansystem/Ads/edit?id='.$val['id'].'&catid='.$val['catid']);?>">修改</a></td>
