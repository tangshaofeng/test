...
<div class="pad-20">
       ...
       <label for="check_box">全选/取消</label>
        <a class="btn-warning " title="排序" href="javascript:void(0);" onclick="myform.action='<?php echo U('Yunzhansystem/Case/more_del?status=1');?>';myform.submit();">排序</a>
        <a class="btn-danger" title="批量删除" href="javascript:void(0)" onclick="myform.action='<?php echo U('Yunzhansystem/Case/more_del?status=2');?>';myform.submit();">批量删除</a>
        <a class="btn-warning " title="添加信息" href="<?php echo U('Yunzhansystem/Case/add');?>" >添加信息</a>
       </span>
...
<div class="main_head">
<h6>
<div class="fl">当前筛选地区：<?php echo ($Areaname); ?></div>
<div class="fr">
</div>
</h6>
</div>
...
<tbody>
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td>
        <a href="<?php echo U('Yunzhansystem/Case/edit?id='.$val['id']);?>"><span><?php echo ($val['title']); ?></span></a>
        <?php if($val['thumb'] != ''): ?>&nbsp;&nbsp;<span class="blue">[图]</span><?php endif; ?>
        </td>
        <td width="100" align="center"><a href="<?php echo U('Yunzhansystem/Case/index?area_id='.$val['area_id']);?>"><?php echo get_row('地区',$val['area_id'],'title');?></a></td>
        <td width="100" align="center"><a href="<?php echo U('Yunzhansystem/Case/index?catid='.$val['catid']);?>"><?php echo ($category[$val['catid']]['title']); ?></a></td>
        ...
        <a href="<?php echo U('Yunzhansystem/Case/edit?id='.$val['id']);?>">修改</a></td>
