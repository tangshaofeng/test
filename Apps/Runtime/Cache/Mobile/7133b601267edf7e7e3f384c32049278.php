...
<div class="category_tree pdlr15">
    ...
    <?php else: ?>
     <ul>
       <?php $_result=get_category($catid);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($vo['id']) == $catid): ?>class="active"<?php endif; ?>><a href="<?php echo ($vo['url']); ?>"><?php echo ($vo['title']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul><?php endif; ?>
</div>
<div class="pro_lists">
<ul>
<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
    <div class="pull_left"><a href="<?php echo ($vo['url']); ?>"><img src="<?php echo thumb($vo['thumb'],151,80);?>" alt="" width="151" height="80"></a></div>
    <div class="pull_right">
    <a href="<?php echo ($vo['url']); ?>" class="title"><?php echo ($vo['title']); ?></a>
    <span class="brand">品牌:   Polycom </span>
    <span class="desc"><?php echo msubstr($vo['description'],0,25);?><a href="<?php echo ($vo['url']); ?>">查看详情</a></span>
    </div>
