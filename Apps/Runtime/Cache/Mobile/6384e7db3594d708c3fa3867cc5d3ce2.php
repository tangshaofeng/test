...
<div class="toptitle">
    <div class="Ft_li"><div class="Sc_li"><div class="Tr_li">
    <a href="<?php echo ($vo['url']); ?>" style="list-style: outside none none;margin-left: 20px;"><?php echo ($topinfo['title']); ?></a>
   </div></div></div>
...
<div class="w container">
    ...
    <div class="right">
      <div class="news-list">
          <ul>
          <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo['url']); ?>" title="<?php echo ($vo['title']); ?>">· <?php echo ($vo['title']); ?></a><span><?php echo date('Y/m/d',$vo['create_time']);?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
          <div class="clh20"></div>
