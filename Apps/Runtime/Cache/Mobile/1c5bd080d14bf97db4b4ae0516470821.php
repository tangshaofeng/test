...
<ul class="jswd_ul">
<?php if(is_array($jswd)): $i = 0; $__LIST__ = $jswd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo['url']); ?>"><img src="<?php echo thumb($vo['thumb'],280,169);?>" alt="<?php echo ($vo['title']); ?>"><span><?php echo ($vo['title']); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
<div class="clear"></div>
<div class="h4_bt"><span>下载中心</span></div>
<ul class="download_ul">
<?php if(is_array($jswd)): $i = 0; $__LIST__ = $jswd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo['url']); ?>">&gt; <?php echo ($vo['title']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
