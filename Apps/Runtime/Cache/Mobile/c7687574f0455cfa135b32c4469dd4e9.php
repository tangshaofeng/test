...
<div class="support-box">
  ...
  <?php if(is_array($ads_fwzd)): $i = 0; $__LIST__ = $ads_fwzd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><span><img src="<?php echo thumb($vo['image'],190,190);?>" alt="<?php echo ($vo['alt']); ?>"><br/><?php echo ($vo['title']); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
  </div>
</div>
<div class="clear"></div>
